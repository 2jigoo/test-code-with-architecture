...
class PostControllerTest {
    ...
    void 사용자는_게시물을_단건_조회할_수_있다() throws Exception {
        ...
        mockMvc.perform(get("/api/posts/1"))
                ...
                .andExpect(jsonPath("$.writer.email").value("2jigoo@naver.com"))
                .andExpect(jsonPath("$.writer.nickname").value("2jigoo"));
    }

    @Test
    void 사용자가_존재하지_않는_게시물_조회를_요청하는_경우_404로_응답한다() throws Exception {
        // given
        // when
        // then
